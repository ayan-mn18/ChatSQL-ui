...
export default function ChatMessage({ message }: ChatMessageProps) {
  ...
  return (
    <div className={`flex gap-4 p-4 ${message.role === 'assistant' ? 'bg-[#1e293b]/30' : ''}`}>
                ...
                {message.result.info.desc && (
                  <div className="bg-blue-500/10 p-4 rounded-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1">
                        <h3 className="font-medium text-blue-200 mb-1">Query Description</h3>
                        <p className="text-blue-300">{message.result.info.desc}</p>
                      </div>
                    </div>
                  </div>
                )}
